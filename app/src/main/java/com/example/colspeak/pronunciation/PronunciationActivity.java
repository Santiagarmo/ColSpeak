...
import com.example.colspeak.MenuReadingActivity;
import com.example.colspeak.R;
...
import com.example.colspeak.vosk.VoskSpeechRecognizer;
...
import com.example.colspeak.MainActivity;
import com.example.colspeak.HelpActivity;

import android.widget.LinearLayout;

import com.example.colspeak.QuizHistoryActivity;
import com.example.colspeak.MenuSpeakingActivity;
import com.example.colspeak.ProgressionHelper;
import com.example.colspeak.pronunciation.PronunciationResultsActivity;
import com.example.colspeak.helpers.WildcardHelper;
import com.example.colspeak.helpers.HelpModalHelper;
import com.example.colspeak.helpers.StarProgressHelper;
import com.example.colspeak.helpers.StarEarnedDialog;
...
public class PronunciationActivity extends AppCompatActivity {
    ...
    private Class<?> getNextSpeakingActivity(String topic) {
        switch (topic) {
            case "NUMBERS":
                return com.example.colspeak.PronNumberActivity.class;
            case "COLORS":
                return com.example.colspeak.PronColorActivity.class;
            case "PERSONAL PRONOUNS":
                return com.example.colspeak.PronPersProActivity.class;
            case "POSSESSIVE ADJECTIVES":
                return com.example.colspeak.PronPosseAdjectActivity.class;
            default:
