...
import com.example.colspeak.ProfileActivity;
import com.example.colspeak.PronunciationHistoryActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (quizMenu != null) {
            quizMenu.setOnClickListener(v -> {
                try {
                    //Intent intent = new Intent(MenuA1Activity.this, com.example.colspeak.quiz.QuizActivity.class);
