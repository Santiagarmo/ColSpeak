...
public class TranslationReadingActivity extends AppCompatActivity {
    ...
    private void initializeViews() {
        ...
        if (wildcardButton != null) {
            wildcardButton.setOnClickListener(v -> {
                try {
                    com.example.colspeak.helpers.WildcardHelper wildcardHelper = new com.example.colspeak.helpers.WildcardHelper(
                        TranslationReadingActivity.this,
                        "READING",
                        selectedTopic
                    );
                    wildcardHelper.setCallbacks(new com.example.colspeak.helpers.WildcardHelper.WildcardCallbacks() {
                        @Override
                        ...
                        public void onShowInstructorVideo() {
                            try {
                                new com.example.colspeak.helpers.VideoHelper(TranslationReadingActivity.this)
    ...
    private void showResults() {
        ...
        btnContinue.setOnClickListener(v -> {
            String nextReadingTopic = com.example.colspeak.ProgressionHelper.getNextReadingTopic(selectedTopic);
            if (nextReadingTopic != null) {
                Class<?> nextActivityClass = com.example.colspeak.ProgressionHelper.getReadingActivityClass(nextReadingTopic);
