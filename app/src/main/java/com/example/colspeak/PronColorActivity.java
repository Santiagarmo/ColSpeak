...
public class PronColorActivity extends AppCompatActivity {
    private static final String TAG = "PronColorActivity";
    ...
    // TextToSpeech
    private String alphabetText = "red   blue   green   yellow   orange   purple   pink   brown   black   white   gray   silver   gold";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pron_color);
    ...
    private void setupClickListeners() {
        ...
        eButtonListening.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PronColorActivity.this, PronunciationActivity.class);
    ...
    private void ReturnMapA1() {
        startActivity(new Intent(PronColorActivity.this, MenuSpeakingActivity.class));
