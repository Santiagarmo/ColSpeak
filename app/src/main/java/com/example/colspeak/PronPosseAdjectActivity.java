...
public class PronPosseAdjectActivity extends AppCompatActivity {
    private static final String TAG = "PronPosseAdjectActivity";
    ...
    // TextToSpeech
    private String alphabetText = "ADJECTIVE: MY YOUR OUR THEIR HIS HER ITS / NOUN: MINE YOURS OURS THEIRS HIS HERS";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pron_posse_adject);
    ...
    private void setupClickListeners() {
        ...
        eButtonListening.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PronPosseAdjectActivity.this, PronunciationActivity.class);
    ...
    private void ReturnMapA1() {
        startActivity(new Intent(PronPosseAdjectActivity.this, MenuSpeakingActivity.class));
        Toast.makeText(PronPosseAdjectActivity.this, "Has retornado correctamente.", Toast.LENGTH_SHORT).show();
    }
