...
import com.example.colspeak.helpers.TrophyHelper;
...
public class ProfileActivity extends AppCompatActivity {
    ...
    private void updateTrophyAndStarCounters() {
        if (trophyCount != null && starCount != null) {
            ...
            int trophiesByStars = com.example.colspeak.helpers.StarProgressHelper.getTrophyCountFromStars(this);
            int trophies = Math.max(trophiesByTopics, trophiesByStars);

            // Estrellas basadas en puntos acumulados (10 puntos = 1 estrella)
            int stars = com.example.colspeak.helpers.StarProgressHelper.getStarCount(this);
