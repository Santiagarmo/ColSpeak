...
import com.example.colspeak.pronunciation.PronunciationActivity;

import com.example.colspeak.components.ReusableAudioPlayerCard;

public class PronPersProActivity extends AppCompatActivity {
    private static final String TAG = "PronPersProActivity";
    ...
    // TextToSpeech
    private String alphabetText = "SINGULAR: I YOU HE SHE IT / PLURAL: WE YOU THEY";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pron_personal);
    ...
    private void setupClickListeners() {
        ...
        eButtonListening.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PronPersProActivity.this, PronunciationActivity.class);
    ...
    private void setupAudioPlayer() {
        try {
            if (reusableAudioPlayerCard != null) {
                ...
                reusableAudioPlayerCard.configure("audio_video/personal_pronouns", alphabetText);
    ...
    private void ReturnMapA1() {
        startActivity(new Intent(PronPersProActivity.this, MenuSpeakingActivity.class));
        Toast.makeText(PronPersProActivity.this, "Has retornado correctamente.", Toast.LENGTH_SHORT).show();
    }
