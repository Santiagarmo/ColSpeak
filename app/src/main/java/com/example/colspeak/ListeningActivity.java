...
public class ListeningActivity extends AppCompatActivity {
    ...
    private com.example.colspeak.components.ReusableAudioPlayerCard reusableAudioCard;
    ...
    // ============================================================
    private com.example.colspeak.components.ModalAlertComponent modalAlertComponent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (modalAlertComponent != null) {
            modalAlertComponent.setOnModalActionListener(new com.example.colspeak.components.ModalAlertComponent.OnModalActionListener() {
                @Override
                public void onContinuePressed(com.example.colspeak.components.ModalAlertComponent.ModalType type) {
                    advanceToNextQuestion();
                }

                @Override
                public void onModalHidden(com.example.colspeak.components.ModalAlertComponent.ModalType type) {
    ...
    private void saveFinalScore(int score) {
        if (selectedTopic != null && selectedLevel != null) {
            ...
            if (finalScore >= 70) {
                com.example.colspeak.helpers.StarProgressHelper.addSessionPoints(this, 10);
            } else {
