...
public class PronNumberActivity extends AppCompatActivity {
    private static final String TAG = "PronNumberActivity";
    ...
    // TextToSpeech
    private String alphabetText = "one   two   three   four   five   six   seven   eight   nine   ten   eleven   twelve   thirteen   fourteen   fifteen   sixteen   seventeen   eighteen   nineteen   twenty   one hundred   one thousand   ten thousand   zero";

    // Control de reproduccióngundos

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pron_number);
    ...
    private void setupClickListeners() {
        ...
        eButtonListening.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PronNumberActivity.this, PronunciationActivity.class);
    ...
    private void ReturnMapA1() {
        startActivity(new Intent(PronNumberActivity.this, MenuSpeakingActivity.class));
