...
public class PossessiveAdjectActivity extends AppCompatActivity {
    private static final String TAG = "PossessiveAdjectActivity";
    ...
    private void setupClickListeners() {
        ...
        eButtonListening.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PossessiveAdjectActivity.this, ListeningActivity.class);
    ...
    private void ReturnMapA1() {
        startActivity(new Intent(PossessiveAdjectActivity.this, MenuA1Activity.class));
